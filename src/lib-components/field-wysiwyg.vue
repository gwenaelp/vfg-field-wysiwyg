  ...
  <div class="editor">
    ...
    >
      <span class="field has-addons">
        <p class="control">
          <button class="button is-small" @click="editor.chain().focus().toggleBold().run()" :class="{ 'is-active': editor.isActive('bold') }">
            Bold
          </button>
        </p>
        <p class="control">
          <button class="button is-small" @click="editor.chain().focus().toggleItalic().run()" :class="{ 'is-active': editor.isActive('italic') }">
            Italic
          </button>
        </p>
        <p class="control">
          <button class="button is-small" @click="editor.chain().focus().toggleStrike().run()" :class="{ 'is-active': editor.isActive('strike') }">
            Strike
          </button>
        </p>
      </span>
